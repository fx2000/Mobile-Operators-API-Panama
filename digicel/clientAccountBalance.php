<?php
/*
 * Client Account Balance (clientAccountBalance)
 * Digicel Panamá
...
// Call clientAccountBalance method and store results in response array
$responseObject = $client->clientAccountBalance($params);
